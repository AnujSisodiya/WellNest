      ...
      <div className="messages-container flex-grow overflow-y-auto p-3 lg:p-6 space-y-3 lg:space-y-4 scrollbar-thin scrollbar-thumb-zinc-600 scrollbar-track-transparent hide-scrollbar">
        {messages.length === 0 ? (
          ...
          messages.map((msg, index) => (
            <div
              key={index}
              className={`flex mb-3 lg:mb-4 ${msg.senderId === user._id ? "justify-end" : "justify-start"
                } animate-in slide-in-from-bottom-2 duration-300`}
            >
              <div className={`flex items-end space-x-2 max-w-[280px] sm:max-w-xs lg:max-w-md ${msg.senderId === user._id ? "flex-row-reverse space-x-reverse" : ""
                }`}>
                ...
                <div
                  className={`relative p-3 lg:p-4 rounded-2xl shadow-lg transform transition-all duration-200 hover:scale-105 ${msg.senderId === user._id
                ...
                >
                  ...
                  <div className={`flex items-center justify-end mt-1 lg:mt-2 space-x-1 ${msg.senderId === user._id ? "text-green-100" : "text-zinc-400"
                    }`}>
                  ...
                  {/* Message tail */}
                  <div className={`absolute bottom-0 w-0 h-0 ${msg.senderId === user._id
